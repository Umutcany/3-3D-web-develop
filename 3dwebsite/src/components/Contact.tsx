...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Temasta Kalın</p>
        <h3 className={styles.sectionHeadText}>Bizimle İletişime Geçin!</h3>
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Lütfen iletmek istediğiniz mesajı giriniz..."
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
            />
          </label>
